  ...
  return (
    <section className="p-3 md:p-5 w-full font-inter">
      <motion.div
        ...
        className='text-2xl sm:text-4xl md:text-[40px] font-medium leading-[1.3] md:leading-[1.2] tracking-tight sm:tracking-wide md:tracking-widest  mx-auto max-w-[1700px] px-2 py-2 md:px-20 lg:px-24 md:text-base lg:text-3xl md:py-16  text-black font-inter'
      >
