  ...
  return (
    <section className="p-3 md:p-5 w-full font-inter my-10">
      <motion.div
        ...
        className='text-lg sm:text-2xl md:text-[40px] font-medium leading-[1.3] md:leading-[1.2] tracking-tight sm:tracking-wide md:tracking-widest  mx-auto max-w-[1700px] px-2 md:px-20 lg:px-24 md:text-base lg:text-3xl   text-black font-inter'
      >
